...
<br>
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <textarea name="description" placeholder="Введите состав" cols="60" rows="10" required></textarea><br>
        <textarea name="description" placeholder="Введите описание" cols="60" rows="10" required></textarea><br>
