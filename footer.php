      ...
      <div class="container text-center text-md-start mt-5 card1">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <a href="index.php"><i class="fas fa-gem me-3" ></i>Snack<i class="fa-regular fa-handshake"></i>cake</a>
            </h6>
            <p>
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            <!-- Links -->
            <h6 class="text-uppercase fw-bold mb-4">
            <a href="Howbuy.php">Покупателям</a>
            </h6>
            <p>
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            <!-- Links -->
            <h6 class="text-uppercase fw-bold mb-4"><a href="Contact.php">Контакты</a></h6>
